...
<body>
	<div id='content' class='container'>
		...
		<form role="form" id="newsForm" method="post" action="m_tmentsSave.shtml">
			
			<input type="hidden" name="id" value="${id}">
			
			<div class="form-group">
				<label for="title" class="col-sm-2">招聘标题</label>
				<div class="col-sm-10">
					<input type="text" class="form-control" id="title" name="title"
						style="width: 500px;" value="${tments.title}">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					排序<input type="text" class="form-control" id="xh"
						name="xh" style="width: 50px;" value="${tments.xh}">
                  
				</div>
				
			</div>
			<div class="form-group">
				<label for="content" class="col-sm-2">招聘内容</label>
				<div class="col-sm-10">
					<textarea rows="20" class="form-control" style="width: 500px;"
						name="content" id="mycontent">${tments.content}</textarea>
					<script>
						...
						CKEDITOR
								.replace(
										'mycontent',
										{
											...
											language : 'zh-cn',
											image_previewText : ' ',
											filebrowserUploadUrl : 'ckUploadImage.shtml?type=3'
										});
					</script>
				</div>
			</div>
